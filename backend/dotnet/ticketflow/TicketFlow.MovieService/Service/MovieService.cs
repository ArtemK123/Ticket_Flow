...
namespace TicketFlow.MovieService.Service
{
    internal class MovieService : IMovieService
    {
        ...
        private readonly IMovieFactory entityFactory;

        public MovieService(IMovieRepository movieRepository, ICinemaHallService cinemaHallService, IFilmService filmService, IMovieFactory entityFactory)
        {
